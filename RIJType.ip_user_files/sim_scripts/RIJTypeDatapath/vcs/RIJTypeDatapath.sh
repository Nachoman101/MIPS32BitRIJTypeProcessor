...
#                script (type 'RIJTypeDatapath.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.RIJTypeDatapath xil_defaultlib.glbl -o RIJTypeDatapath_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./RIJTypeDatapath_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key RIJTypeDatapath_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc RIJTypeDatapath_simv.daidir vcs_lib c.obj)
