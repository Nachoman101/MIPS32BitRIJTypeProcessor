...
#
# Script generated by Vivado on Thu Aug 01 01:24:27 -0400 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : RIJTypeDatapath.sh
...
#
# Usage        : RIJTypeDatapath.sh
#                RIJTypeDatapath.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RIJTypeDatapath.sh [-reset_run]
#                RIJTypeDatapath.sh [-reset_log]
#                RIJTypeDatapath.sh [-help]
#
...
# script info
echo -e "RIJTypeDatapath.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RIJTypeDatapath.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlslice_v1_0_3 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RIJTypeDatapath xil_defaultlib.RIJTypeDatapath xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RIJTypeDatapath -key {Behavioral:sim_1:Functional:RIJTypeDatapath} -tclbatch cmd.tcl -protoinst "protoinst_files/RIJTypeDatapath.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RIJTypeDatapath.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RIJTypeDatapath.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RIJTypeDatapath.sh [-help]\n\
Usage: RIJTypeDatapath.sh [-step]\n\
Usage: RIJTypeDatapath.sh [-lib_map_path]\n\
Usage: RIJTypeDatapath.sh [-reset_run]\n\
Usage: RIJTypeDatapath.sh [-reset_log]\n\
Usage: RIJTypeDatapath.sh [-keep_index]\n\
Usage: RIJTypeDatapath.sh [-noclean_files]\n\n\
